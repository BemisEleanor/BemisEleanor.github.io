...
#building1 = Building(0, 400, random.randint(50,300), random.randint(200,400), BLUE)
...
#     """
        ...
        def add_buildings(self):
            ...
            while temp_width <= self.width:
                ...
                temp_width += self.building_list[-1].width
#         """
...
#         """
        ...
        def add_building(self, x_location):
            ...
            height = random.randint(-300,-150)
            y_point = self.base-self.height

            self.building_list.append(Building(x_location, y_point, width, height,self.color))
#         
